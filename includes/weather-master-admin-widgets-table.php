...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-weathermaster-admin-widget-basic.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('weather_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-weathermaster-admin-widget-advanced.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('weather_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-weathermaster-admin-widget-geo.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('weather_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-weathermaster-admin-widget-current.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('weather_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-weathermaster-admin-widget-forecast.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('weather_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-weathermaster-admin-widget-dashboard.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('weather_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
