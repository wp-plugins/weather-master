<?php
if( is_multisite() ) {
	function menu_multi_weather_admin_addons(){
	// Create menu
...
<h2><b>&nbsp;<?php echo get_option('weather_master_name'); ?> Add-ons</b></h2>
<?php
if(!class_exists('weather_master_admin_addons_table')){
	require_once( dirname( __FILE__ ) . '/weather-master-admin-addons-table.php');
}
...
if( is_multisite() ) {
add_action( 'network_admin_menu', 'menu_multi_weather_admin_addons' );
}
else {
